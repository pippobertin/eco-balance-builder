                      ...
                      <div className="space-y-4 mt-4 border-t pt-4">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {subsidiaries.map((subsidiary, index) => (
                            <div 
                              key={index} 
                              className="flex items-center bg-blue-100 dark:bg-blue-900 px-3 py-1 rounded-full"
                            >
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md mb-4">
                    <p className="text-sm">
                      Hai selezionato: <strong>{
                        selectedOption === 'A' ? 'OPZIONE A: Modulo Base' : 
                        selectedOption === 'B' ? 'OPZIONE B: Modulo Base e Modulo Narrativo-PAT' :
                        selectedOption === 'C' ? 'OPZIONE C: Modulo Base e Modulo Partner commerciali' :
