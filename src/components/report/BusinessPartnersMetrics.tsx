        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                checked={formValues.businessPartnersMetrics?.controversialWeapons} 
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                id="tobacco" 
                checked={formValues.businessPartnersMetrics?.tobacco} 
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                id="fossilFuels" 
                checked={formValues.businessPartnersMetrics?.fossilFuels} 
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                id="chemicals" 
                checked={formValues.businessPartnersMetrics?.chemicals} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.controversialWeaponsRevenue || ""}
                onChange={handleChange}
                disabled={!formValues.businessPartnersMetrics?.controversialWeapons}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.tobaccoRevenue || ""}
                onChange={handleChange}
                disabled={!formValues.businessPartnersMetrics?.tobacco}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.coalRevenue || ""}
                onChange={handleChange}
                disabled={!formValues.businessPartnersMetrics?.fossilFuels}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.oilRevenue || ""}
                onChange={handleChange}
                disabled={!formValues.businessPartnersMetrics?.fossilFuels}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.gasRevenue || ""}
                onChange={handleChange}
                disabled={!formValues.businessPartnersMetrics?.fossilFuels}
              />
            </div>
          ...
          <div>
            ...
            <Input
              ...
              type="number"
              placeholder="0.0"
              value={formValues.businessPartnersMetrics?.chemicalsRevenue || ""}
              onChange={handleChange}
              disabled={!formValues.businessPartnersMetrics?.chemicals}
            />
          </div>
        </div>
      </GlassmorphicCard>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                name="maleGovernanceMembers"
                type="number"
                placeholder="0"
                value={formValues.businessPartnersMetrics?.maleGovernanceMembers || ""}
                onChange={handleChange}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                name="femaleGovernanceMembers"
                type="number"
                placeholder="0"
                value={formValues.businessPartnersMetrics?.femaleGovernanceMembers || ""}
                onChange={handleChange}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                name="otherGenderGovernanceMembers"
                type="number"
                placeholder="0"
                value={formValues.businessPartnersMetrics?.otherGenderGovernanceMembers || ""}
                onChange={handleChange}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <Input
              ...
              type="number"
              placeholder="0.0"
              value={formValues.businessPartnersMetrics?.genderDiversityIndex || ""}
              onChange={handleChange}
            />
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              ...
              checked={formValues.businessPartnersMetrics?.hasGhgReductionTargets} 
              onCheckedChange={(checked) => handleCheckboxChange('hasGhgReductionTargets', !!checked)}
            />
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    name="ghgReductionTargetScope1"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.ghgReductionTargetScope1 || ""}
                    onChange={handleChange}
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    name="ghgReductionTargetScope2"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.ghgReductionTargetScope2 || ""}
                    onChange={handleChange}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    name="ghgReductionTargetScope3"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.ghgReductionTargetScope3 || ""}
                    onChange={handleChange}
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    name="ghgReductionTargetYear"
                    type="number"
                    placeholder="2030"
                    value={formValues.businessPartnersMetrics?.ghgReductionTargetYear || ""}
                    onChange={handleChange}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  name="ghgReductionBaselineYear"
                  type="number"
                  placeholder="2019"
                  value={formValues.businessPartnersMetrics?.ghgReductionBaselineYear || ""}
                  onChange={handleChange}
                />
              </div>
            </>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              ...
              checked={formValues.businessPartnersMetrics?.hasTransitionPlan} 
              onCheckedChange={(checked) => handleCheckboxChange('hasTransitionPlan', !!checked)}
            />
          ...
          {formValues.businessPartnersMetrics?.hasTransitionPlan && (
            <div>
              ...
              <Textarea
                ...
                value={formValues.businessPartnersMetrics?.transitionPlanDetails || ""}
                onChange={handleChange}
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              ...
              checked={formValues.businessPartnersMetrics?.hasPhysicalClimateRisks} 
              onCheckedChange={(checked) => handleCheckboxChange('hasPhysicalClimateRisks', !!checked)}
            />
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    name="assetsAtRiskAmount"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.assetsAtRiskAmount || ""}
                    onChange={handleChange}
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    name="assetsAtRiskPercentage"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.assetsAtRiskPercentage || ""}
                    onChange={handleChange}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    name="adaptationCoverage"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.adaptationCoverage || ""}
                    onChange={handleChange}
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    name="revenueAtRiskPercentage"
                    type="number"
                    placeholder="0.0"
                    value={formValues.businessPartnersMetrics?.revenueAtRiskPercentage || ""}
                    onChange={handleChange}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={formValues.businessPartnersMetrics?.realEstateEnergyEfficiency || ""}
                  onChange={handleChange}
                  className="min-h-[100px]"
                />
              </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              ...
              checked={formValues.businessPartnersMetrics?.hasHazardousWaste} 
              onCheckedChange={(checked) => handleCheckboxChange('hasHazardousWaste', !!checked)}
            />
          ...
          {formValues.businessPartnersMetrics?.hasHazardousWaste && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="hazardousWasteTotal">Quantità totale di rifiuti pericolosi (tonnellate)</Label>
                <Input
                  id="hazardousWasteTotal"
                  name="hazardousWasteTotal"
                  type="number"
                  placeholder="0.0"
                  value={formValues.businessPartnersMetrics?.hazardousWasteTotal || ""}
                  onChange={handleChange}
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  name="radioactiveWasteTotal"
                  type="number"
                  placeholder="0.0"
                  value={formValues.businessPartnersMetrics?.radioactiveWasteTotal || ""}
                  onChange={handleChange}
                />
              </div>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              ...
              checked={formValues.businessPartnersMetrics?.hasPoliciesAligned} 
              onCheckedChange={(checked) => handleCheckboxChange('hasPoliciesAligned', !!checked)}
            />
          ...
          {formValues.businessPartnersMetrics?.hasPoliciesAligned && (
            <div>
              ...
              <Textarea
                ...
                value={formValues.businessPartnersMetrics?.alignedInstruments || ""}
                onChange={handleChange}
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              ...
              checked={formValues.businessPartnersMetrics?.hasComplianceProcesses} 
              onCheckedChange={(checked) => handleCheckboxChange('hasComplianceProcesses', !!checked)}
            />
          ...
          {formValues.businessPartnersMetrics?.hasComplianceProcesses && (
            <div>
              ...
              <Textarea
                ...
                value={formValues.businessPartnersMetrics?.complianceProcessesDetails || ""}
                onChange={handleChange}
                className="min-h-[150px]"
              />
            </div>
      ...
      <GlassmorphicCard>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              id="hasViolations" 
              checked={formValues.businessPartnersMetrics?.hasViolations} 
              onCheckedChange={(checked) => handleCheckboxChange('hasViolations', !!checked)}
            />
          ...
          {formValues.businessPartnersMetrics?.hasViolations && (
            <div>
              ...
              <Textarea
                ...
                value={formValues.businessPartnersMetrics?.violationsDetails || ""}
                onChange={handleChange}
                className="min-h-[150px]"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                name="maleFamilyLeaveEligible"
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.maleFamilyLeaveEligible || ""}
                onChange={handleChange}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                name="femaleFamilyLeaveEligible"
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.femaleFamilyLeaveEligible || ""}
                onChange={handleChange}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                name="maleFamilyLeaveUsed"
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.maleFamilyLeaveUsed || ""}
                onChange={handleChange}
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                name="femaleFamilyLeaveUsed"
                type="number"
                placeholder="0.0"
                value={formValues.businessPartnersMetrics?.femaleFamilyLeaveUsed || ""}
                onChange={handleChange}
              />
            </div>
          </div>
      ...
      <GlassmorphicCard>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox 
              id="hasApprentices" 
              checked={formValues.businessPartnersMetrics?.hasApprentices} 
              onCheckedChange={(checked) => handleCheckboxChange('hasApprentices', !!checked)}
            />
          ...
          {formValues.businessPartnersMetrics?.hasApprentices && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="apprenticesNumber">Numero di apprendisti</Label>
                <Input
                  id="apprenticesNumber"
                  name="apprenticesNumber"
                  type="number"
                  placeholder="0"
                  value={formValues.businessPartnersMetrics?.apprenticesNumber || ""}
                  onChange={handleChange}
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  name="apprenticesPercentage"
                  type="number"
                  placeholder="0.0"
                  value={formValues.businessPartnersMetrics?.apprenticesPercentage || ""}
                  onChange={handleChange}
                />
              </div>
            </div>
