        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Textarea
                id="antiCorruptionPolicies"
                name="antiCorruptionPolicies"
                placeholder="Descrivi le politiche anti-corruzione in vigore nell'impresa."
                value={formValues.conductMetrics?.antiCorruptionPolicies || ""}
                onChange={handleChange}
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Descrivi le attività di formazione anti-corruzione svolte nel periodo di riferimento."
                value={formValues.conductMetrics?.antiCorruptionTraining || ""}
                onChange={handleChange}
                className="min-h-[100px]"
              />
            </div>
      ...
      <GlassmorphicCard>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              id="reportedViolations"
              name="reportedViolations"
              placeholder="Indica se si sono verificate violazioni dei principi e delle linee guida internazionali in relazione alla propria forza lavoro."
              value={formValues.conductMetrics?.reportedViolations || ""}
              onChange={handleChange}
              className="min-h-[120px]"
            />
          </div>
