  ...
  return (
    <div className="border rounded-md p-4 bg-white/80">
      ...
      <div className="mt-8 space-y-6">
        ...
        {calculationLogs && calculationLogs.scope1Calculations && calculationLogs.scope1Calculations.length > 0 && (
        ...
        {calculationLogs && calculationLogs.scope2Calculations && calculationLogs.scope2Calculations.length > 0 && (
          <EmissionsCalculationTable 
            scope="scope2"
        ...
        {calculationLogs && calculationLogs.scope3Calculations && calculationLogs.scope3Calculations.length > 0 && (
          <EmissionsCalculationTable 
            scope="scope3"
