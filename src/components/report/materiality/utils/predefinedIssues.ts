...
export const predefinedIssues: MaterialityIssue[] = [
  ...
  createHeaderTheme('environmental-climate-header', 'Cambiamenti climatici'),
  ...
  createHeaderTheme('environmental-pollution-header', 'Inquinamento'),
  ...
  createHeaderTheme('social-workforce-header', 'Forza lavoro propria'),
  ...
  createHeaderTheme('social-value-chain-header', 'Lavoratori nella catena del valore'),
  ...
  createBasicIssue('labor-training', 'Formazione', 'Promozione della formazione nella catena del valore'),
  ...
  createHeaderTheme('social-consumers-header', 'Consumatori e utilizzatori finali'),
  ...
  createHeaderTheme('governance-conduct-header', 'Condotta delle imprese'),
