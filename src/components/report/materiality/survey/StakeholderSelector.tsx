    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center p-3 rounded-md bg-slate-100">
        ...
        {allStakeholders.length > 0 && (
          <Button variant="outline" size="sm" onClick={toggleSelectAllStakeholders}>
      ...
      <div className="space-y-2">
        <h4 className="font-medium flex items-center gap-2 text-sm text-gray-700">
          ...
          <div className="space-y-2 p-3 rounded-md border bg-blue-50">
            {pending.map(stakeholder => (
              <div key={stakeholder.id} className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor={`stakeholder-${stakeholder.id}`} className="flex items-center text-gray-800">
